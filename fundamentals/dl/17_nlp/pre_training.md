  ...
  - Unigram
    ...
    - At each step, you discard the token whereby doing so increases the loss the least. 
      - The likelihood is the summed log probability of generating each word
        - The probability of generating a word is the probability of its most likely tokenization, where a tokenization's probability is the product of its tokens' unigram probabilities
