...
- Discrete Audio Tokens
  ...
  - SoundStream, Encodec
    - Rough notes on codebooks after stepping through encodec code:
      ...
      - We have a small number of codebooks (one per RVQ stage — 2 in this trace), each containing 1024 codewords of dimension (128,)
      - For each of the 336 segments, we find the nearest codeword, then quantize the residual with the next stage's codebook. 
