...
- Definitions
  - Per [Sharkey](https://arxiv.org/pdf/2501.16496), there are 3 threads of interpretability:
    - Build AI systems that are interpretable by design - think simpler models, or explaining the sensitivity of machine learning models to inputs and training data.
      - Feature importance
        - Shapley Values
          - A feature's average marginal contribution to the prediction over all possible feature coalitions/orderings. (Randomizing one feature's values and measuring the accuracy drop is a different method — permutation feature importance.)
