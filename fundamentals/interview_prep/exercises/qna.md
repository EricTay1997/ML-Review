...
- General Statistics
  ...
  - What's the formula for $\mathrm{Cov}(f(X), g(Y))$? 
  - What's the formula for $\pmb{\Sigma} \stackrel{\text { def }}{=} \mathrm{Cov}_{\mathbf{x} \sim p}[\mathbf{x}]$? Formula for correlation?  Why is this psd?
