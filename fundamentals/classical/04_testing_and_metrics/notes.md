...
* Metrics
  ...
  * Details
    ...
    * Some other terms (that can be used both in/out of binary classification)
      * The **p-value** is the probability, under the null hypothesis assumptions, of observing a test statistic at least as extreme as the one calculated. We usually compare the observed p-value to a chosen level of alpha.
